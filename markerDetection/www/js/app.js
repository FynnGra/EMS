...
//var cockpitStream = document.createElement('img');
//cockpitStream.crossOrigin = "Anonymous";
...
function successCallback(stream){
  ...
  //cockpitStream.src = "http://192.168.0.11/?action=stream";
}
...
/* --------------- control function ------------------- */
/* ---------------------------------------------------- */
var mRobotWatchMotion = null;
var cordovaDeviceMotion = null; // has to be set in angular function
var mRobotControl = {
  // watcher object for motion sensors
  watchMotion: null,

  // start measurements
  startWatching: function(){
    // device motion configuration
    mRobotWatchMotion = cordovaDeviceMotion.watchAcceleration({frequency: 200 /* measure every 200ms */ });

    mRobot.control.requestDriveControl();

    // device motion initilaization
    mRobotWatchMotion.then(null, function (error) {
  ...
  requestDriveControl: function(){
    mRobot.control.requestDriveControl();
  },

  driveRobot: function(speed, direction){
    mRobot.control.driveRobot(speed, direction);
  },
  ...
  getBattery: function(){
    return mRobot.control.variables.batteryPercentage;
  },

  stopWatching: function(){
    mRobotWatchMotion.clearWatch(); // turn off motion detection watcher
  },
