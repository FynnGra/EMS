/*
 * Description: Small augmented reality application using WebRTC, JSARToolKit, THREE.js
...
var width = 640; //1280 o. 320
var height = 480; //740 o. 240
...
.directive('webcamGl', [function() {
  ...
  function create(glFrame) {
    ...
    videoTex.anisotropy = renderer.getMaxAnisotropy();
    ...
    var videoCam = new THREE.PerspectiveCamera();
    videoCam.position.z = 2;
    ...
    window.setInterval(function() {
      ...
      //effect.render(videoScene, videoCam);
